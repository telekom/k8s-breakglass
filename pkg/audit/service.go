...
// The returned pointer is safe to cache: it is non-nil only after the first successful
// Reload/ReloadMultiple call and remains valid for the lifetime of the Service.
