...
const (
	...
	EventSessionWithdrawn   EventType = "session.withdrawn"
	EventSessionDropped     EventType = "session.dropped"
	...
	EventDebugSessionCleanupRecovered EventType = "debug_session.cleanup_recovered"
