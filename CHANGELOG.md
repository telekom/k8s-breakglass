...
- **Approval email failure silent** ([#546](https://github.com/telekom/k8s-breakglass/issues/546)): Session approval API response now includes `notificationSent` field indicating whether the approval email was successfully enqueued, giving approvers visibility into notification delivery status
