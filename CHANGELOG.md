...
- **Frontend: stable v-for key in BreakglassSessionReview** ([#535](https://github.com/telekom/k8s-breakglass/issues/535)): Use metadata.name as primary key with session-${index} as last-resort fallback
