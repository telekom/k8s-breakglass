...
- **User-flow recordings**: Added reproducible E2E API/webhook, `bgctl`/`kubectl`, and browser UI recordings covering denial, approval, Kubernetes identity/API access, deny-policy precedence, DebugSession creation, and debug-pod `tcpdump` usage.
