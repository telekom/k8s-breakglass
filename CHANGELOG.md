...
- **Frontend: Scale design token alignment**: Aligned frontend typography, motion, spacing, loading states, and debug-session constraint tags with Telekom Scale design tokens, including a neutral header fallback for deployments without branded header imagery.
