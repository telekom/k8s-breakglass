...
- **Frontend dependency audit fixes**: Updated vulnerable Babel and brace-expansion transitive dependencies in the frontend lockfile and deduplicated Babel parser/types resolutions.
