...
- **User-flow recordings**: Added reproducible, narrated and paced E2E API/webhook, `bgctl`/`kubectl`, and browser-plus-console recordings covering denial, approval, Kubernetes identity/API access, deny-policy precedence, DebugSession creation, and debug-pod `tcpdump` usage.
