...
- **CI: enforce ORT scan findings**: ORT now fails CI when unresolved issues or policy violations remain, with a static workflow guard to prevent accidentally disabling enforcement.
