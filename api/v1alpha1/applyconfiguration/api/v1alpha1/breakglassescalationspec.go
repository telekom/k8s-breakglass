...
type BreakglassEscalationSpecApplyConfiguration struct {
	...
	SessionLimitsOverride *SessionLimitsOverrideApplyConfiguration `json:"sessionLimitsOverride,omitempty"`
}
...
// WithSessionLimitsOverride sets the SessionLimitsOverride field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the SessionLimitsOverride field is set to the value of the last call.
func (b *BreakglassEscalationSpecApplyConfiguration) WithSessionLimitsOverride(value *SessionLimitsOverrideApplyConfiguration) *BreakglassEscalationSpecApplyConfiguration {
	b.SessionLimitsOverride = value
	return b
}
