...
func BreakglassSessionStatusFrom(status *telekomv1alpha1.BreakglassSessionStatus) *ac.BreakglassSessionStatusApplyConfiguration {
	...
	// These fields are owned by the "activity-tracker" SSA field manager
	// (see pkg/webhook/activity_tracker.go) and must not be set by the main
	// controller to avoid SSA ownership conflicts.
