...
//
// +kubebuilder:validation:XValidation:rule="!has(self.groupSyncProvider) || self.groupSyncProvider != 'Keycloak' || has(self.keycloak)",message="keycloak configuration is required when groupSyncProvider is 'Keycloak'"
