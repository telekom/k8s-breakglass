...
func main() {
	...
	sessionManager := breakglass.NewSessionManagerWithClientAndReader(reconcilerMgr.GetClient(), reconcilerMgr.GetAPIReader(), breakglass.WithSessionLogger(log.Named("session-manager")))
