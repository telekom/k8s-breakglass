...
func TestMatchTargetCgroupSupportedLayouts(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "containerd systemd inline system slice embedded qos", path: "0::/system.slice/kubepods-burstable-pod" + underscored + ".slice:cri-containerd:" + containerID + ".scope", family: "cri-containerd"},
		{name: "containerd systemd inline containerd service", path: "0::/system.slice/containerd.service/kubepods-burstable-pod" + underscored + ".slice:cri-containerd:" + containerID + ".scope", family: "cri-containerd"},
		{name: "containerd systemd inline containerd service qos", path: "0::/system.slice/containerd.service/kubepods.slice/kubepods-burstable.slice/kubepods-burstable-pod" + underscored + ".slice:cri-containerd:" + containerID + ".scope", family: "cri-containerd"},
		{name: "containerd systemd inline kubelet service", path: "0::/system.slice/kubelet.service/kubepods-burstable-pod" + underscored + ".slice:cri-containerd:" + containerID + ".scope", family: "cri-containerd"},
...
func TestMatchTargetCgroupRejectsConfusableAndUnknownLayouts(t *testing.T) {
	...
	tests := []string{
		...
		"0::/system.slice/other.service/kubepods-burstable-pod" + strings.ReplaceAll(testUID, "-", "_") + ".slice:cri-containerd:" + containerID + ".scope",
