...
expect_rejected "dump command override" helm template debug-catalogue "${chart_dir}" \
  --set-json 'profiles=[{"name":"dump-access","intent":"dump-access","displayName":"Dump access","description":"Read approved dump","enabled":true,"elevated":false,"imageKey":"dumpAccess","command":["/bin/cat"],"args":["copy","/input/fixture.dump"],"sourcePath":"/input/fixture.dump","allowExec":false,"pod":{"volumeMounts":[{"name":"input","mountPath":"/input","readOnly":true},{"name":"output","mountPath":"/output"}],"volumes":[{"name":"input","hostPath":{"path":"/var/lib/catalogue-fixtures/dumps","type":"Directory"}},{"name":"output","emptyDir":{"sizeLimit":"1Gi"}}]}}]'

expect_rejected "dump source mounted at a second path" helm template debug-catalogue "${chart_dir}" \
  --set-json 'profiles=[{"name":"dump-access","intent":"dump-access","displayName":"Dump access","description":"Read approved dump","enabled":true,"elevated":false,"imageKey":"dumpAccess","command":["/usr/local/bin/dump-reader"],"args":["copy","/input/fixture.dump"],"sourcePath":"/input/fixture.dump","allowExec":false,"pod":{"volumeMounts":[{"name":"input","mountPath":"/input","readOnly":true},{"name":"input","mountPath":"/alternate-input","readOnly":true},{"name":"output","mountPath":"/output"}],"volumes":[{"name":"input","hostPath":{"path":"/var/lib/catalogue-fixtures/dumps","type":"Directory"}},{"name":"output","emptyDir":{"sizeLimit":"1Gi"}}]}}]'

expect_rejected "dump source writable alternate mount" helm template debug-catalogue "${chart_dir}" \
  --set-json 'profiles=[{"name":"dump-access","intent":"dump-access","displayName":"Dump access","description":"Read approved dump","enabled":true,"elevated":false,"imageKey":"dumpAccess","command":["/usr/local/bin/dump-reader"],"args":["copy","/input/fixture.dump"],"sourcePath":"/input/fixture.dump","allowExec":false,"pod":{"volumeMounts":[{"name":"input","mountPath":"/input","readOnly":true},{"name":"input","mountPath":"/alternate-input"},{"name":"output","mountPath":"/output"}],"volumes":[{"name":"input","hostPath":{"path":"/var/lib/catalogue-fixtures/dumps","type":"Directory"}},{"name":"output","emptyDir":{"sizeLimit":"1Gi"}}]}}]'

expect_rejected "dump source without an explicit path" helm template debug-catalogue "${chart_dir}" \
  --set-json 'profiles=[{"name":"dump-access","intent":"dump-access","displayName":"Dump access","description":"Read approved dump","enabled":true,"elevated":false,"imageKey":"dumpAccess","command":["/usr/local/bin/dump-reader"],"args":["copy","/input/fixture.dump"],"allowExec":false,"pod":{"volumeMounts":[{"name":"input","mountPath":"/input","readOnly":true},{"name":"output","mountPath":"/output"}],"volumes":[{"name":"input","hostPath":{"path":"/var/lib/catalogue-fixtures/dumps","type":"Directory"}},{"name":"output","emptyDir":{"sizeLimit":"1Gi"}}]}}]'

expect_rejected "dump output mounted from the wrong volume" helm template debug-catalogue "${chart_dir}" \
  --set-json 'profiles=[{"name":"dump-access","intent":"dump-access","displayName":"Dump access","description":"Read approved dump","enabled":true,"elevated":false,"imageKey":"dumpAccess","command":["/usr/local/bin/dump-reader"],"args":[],"sourcePath":"/input/fixture.dump","allowExec":false,"pod":{"volumeMounts":[{"name":"input","mountPath":"/input","readOnly":true},{"name":"unbounded","mountPath":"/output"}],"volumes":[{"name":"input","hostPath":{"path":"/var/lib/catalogue-fixtures/dumps","type":"Directory"}},{"name":"output","emptyDir":{"sizeLimit":"1Gi"}},{"name":"unbounded","emptyDir":{}}]}}]'

expect_rejected "duplicate dump output mounts" helm template debug-catalogue "${chart_dir}" \
  --set-json 'profiles=[{"name":"dump-access","intent":"dump-access","displayName":"Dump access","description":"Read approved dump","enabled":true,"elevated":false,"imageKey":"dumpAccess","command":["/usr/local/bin/dump-reader"],"args":[],"sourcePath":"/input/fixture.dump","allowExec":false,"pod":{"volumeMounts":[{"name":"input","mountPath":"/input","readOnly":true},{"name":"output","mountPath":"/output"},{"name":"output","mountPath":"/output"}],"volumes":[{"name":"input","hostPath":{"path":"/var/lib/catalogue-fixtures/dumps","type":"Directory"}},{"name":"output","emptyDir":{"sizeLimit":"1Gi"}}]}}]'

expect_rejected "read-only dump output mount" helm template debug-catalogue "${chart_dir}" \
  --set-json 'profiles=[{"name":"dump-access","intent":"dump-access","displayName":"Dump access","description":"Read approved dump","enabled":true,"elevated":false,"imageKey":"dumpAccess","command":["/usr/local/bin/dump-reader"],"args":[],"sourcePath":"/input/fixture.dump","allowExec":false,"pod":{"volumeMounts":[{"name":"input","mountPath":"/input","readOnly":true},{"name":"output","mountPath":"/output","readOnly":true}],"volumes":[{"name":"input","hostPath":{"path":"/var/lib/catalogue-fixtures/dumps","type":"Directory"}},{"name":"output","emptyDir":{"sizeLimit":"1Gi"}}]}}]'

expect_rejected "dump output redirect" helm template debug-catalogue "${chart_dir}" \
  --set-json 'profiles=[{"name":"dump-access","intent":"dump-access","displayName":"Dump access","description":"Read approved dump","enabled":true,"elevated":false,"imageKey":"dumpAccess","command":["/usr/local/bin/dump-reader"],"args":[],"sourcePath":"/input/fixture.dump","allowExec":false,"pod":{"env":[{"name":"DUMP_OUTPUT_DIR","value":"/tmp"}],"volumeMounts":[{"name":"input","mountPath":"/input","readOnly":true},{"name":"output","mountPath":"/output"}],"volumes":[{"name":"input","hostPath":{"path":"/var/lib/catalogue-fixtures/dumps","type":"Directory"}},{"name":"output","emptyDir":{"sizeLimit":"1Gi"}}]}}]'
